...
# 2. AYARLAR VE TOKEN (Yeni Tokenınız Gömüldü)
...
async def start_game(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = await update.message.reply_text("⏳ *İYUK Final Game Başlatılıyor...*\nEski CMK kalıntıları temizlendi.", parse_mode="Markdown")
    await asyncio.sleep(2)
...
def main():
    ...
    print("Bot yayında. Eski güncellemeler temizleniyor...")
